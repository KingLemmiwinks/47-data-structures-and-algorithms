...
function longest(words, i = 0, currentLongest = 0) {
  if (i === words.length) return currentLongest;
  currentLongest = Math.max(words[i].length, currentLongest);
  return longest(words, i + 1, currentLongest);
